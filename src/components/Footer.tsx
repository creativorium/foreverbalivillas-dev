    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.col}>
          ...
          <a href="mailto:bookings@foreverbalisvillas.com" className={styles.link}>
            bookings@foreverbalisvillas.com
          </a>
          <a href={`tel:+6285954173599`} className={styles.link}>
            +62 859 5417 3599
          </a>
        </div>
