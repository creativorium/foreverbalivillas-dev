        ...
        <div ref={metaRef} className={styles.meta}>
          ...
          <div className={styles.metaGroup}>
            ...
            <div className={styles.metaLinks}>
              <a href="mailto:bookings@foreverbalisvillas.com" className={styles.metaLink}>
                bookings@foreverbalisvillas.com
              </a>
              <span className={styles.metaSep}>|</span>
              <a href="tel:+6285954173599" className={styles.metaLink}>+62 859 5417 3599</a>
            </div>
          </div>
          ...
          <div className={styles.metaGroup}>
            ...
            <div className={styles.socialRow}>
              ...
              <a href={`https://wa.me/${WA}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.socialIcon}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
